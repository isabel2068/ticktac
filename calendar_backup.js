...
let currentView = new Date(2026, 3, 1); // Default to April 2026
                ...
                <ul>${dailyEvents.map(e => `
                    <li>
                        ...
                        <div class="location-details">
                            <div class="location-item"><span class="loc-label">Location:</span> ${e.location}</div>
                            <div class="location-item"><span class="loc-label">Venue:</span> ${e.venue}</div>
                        </div>
